...
The goal of bsrto is to generate data products for the [Barrow Strait Real Time Observatory](https://noise.phys.ocean.dal.ca/barrow/).
...
You can build other products as well, including the [Navigator](https://navigator.oceansdata.ca/) data:
